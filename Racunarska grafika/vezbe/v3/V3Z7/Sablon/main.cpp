...
int main(void)
{
    ...
    float vertices[] = //Tjemena trougla koja sadrze sve informacije o njemu
    {
        ...
        //Pozicija    |    Boja
        //X    Y       R    G    B    A
        0.25, 0.3,    1.0, 1.0, 0.0, 0.0, //prvo tjeme
        -0.25, 0.3,   1.0, 0.0, 1.0, 0.0, //drugo tjeme
        0.0, 0.6,     0.0, 1.0, 1.0, 0.0, //trece tjeme
        
        0.25, -0.3,    1.0, 0.0, 0.0, 0.0, //prvo tjeme
        -0.25, -0.3,   0.0, 1.0, 0.0, 0.0, //drugo tjeme
    ...
    float r = 0.25;      //Poluprecnik kruznice po kojoj se trougao krece, mora biti manji od najmanje apsolutne vrednosti y koordinate temena
    float rotationSpeed = 0.7; //brzina rotacije trouglova
    while (!glfwWindowShouldClose(window)) //Beskonacna petlja iz koje izlazimo tek kada prozor treba da se zatvori
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 6); //To i nacrtamo
